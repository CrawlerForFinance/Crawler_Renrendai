...
#for crawl
urlUser = 'https://www.we.com/account/myInfo.action?userId='
urlLoanList = 'https://www.we.com/account/myInfo!userDetailLoanList.action?userId='
urlFP = 'http://www.we.com/financeplan/listPlan!detailPlan.action?financePlanId='
userFolder = 'Users/'
...
def getUserData(webcontent, userID, writers):
    ...
    ###借款列表
    pageIndex = 1
    for pageIndex in range(1, int(int(bb[3])/20)+2):
        tryCount = 0;
        while(tryCount < 5):
            tryCount += 1
